    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path="/ideas" element={isAuthenticated() ? <IdeaSubmission /> : <Navigate to="/login" />}  />
                <Route path="/collaborate" element={isAuthenticated() ? <CollaborationTools /> : <Navigate to="/login" />}  />
